...
ADMIN_USERNAME = get_default(config, 'admin_username', 'admin')
ADMIN_PASSWORD = get_default(config, 'admin_password', 'admin')
ADMIN_SECRET = get_default(config, 'admin_secret', 'admin')
